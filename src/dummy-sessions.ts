...
export const SESSIONS = [
  {
    ...
    shortDescription: 'Tailored guidance for total beginners in React.',
    longDescription:
    ...
    duration: 1,
    date: '2023-11-01',
    visual: kickstartReact,
    durationInMinutes: 60
  },
  {
    id: 'sess02',
    title: 'Debugging Your React Code',
    shortDescription: "Stuck with a React bug? Let's squash it together.",
    longDescription:
  ...
  },
  {
    ...
    shortDescription: 'Optimize and refactor your components.',
    longDescription:
    ...
    duration: 1.5,
    date: '2023-11-07',
    visual: blueprintComponent,
    durationInMinutes: 90
  },
  {
    id: 'sess04',
    title: 'Effective State Management Tactics',
    shortDescription: 'Strategies to manage state efficiently.',
    longDescription:
    ...
    duration: 2,
    date: '2023-11-09',
    visual: stateMgmtFlow,
    durationInMinutes: 120
  },
  {
    id: 'sess05',
    title: 'Custom Hooks Creation',
    shortDescription: 'Craft your custom hooks.',
    longDescription:
  ...
  },
  {
    ...
    shortDescription: 'Discuss and implement styling solutions.',
    longDescription:
  ...
  },
  {
    ...
    shortDescription: 'Fetch, display, and handle data efficiently.',
    longDescription:
  ...
  },
  {
    ...
    shortDescription: 'Strengthen your code with TypeScript.',
    longDescription:
  ...
  },
  {
    ...
    shortDescription: 'Optimizations to make your app blazing fast.',
    longDescription:
  ...
  },
  {
    ...
    shortDescription: 'Master global state and async actions.',
    longDescription:
